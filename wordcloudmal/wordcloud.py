...
words_tr = translit_list(con,words)
...
top50 = [word for word,freq in fd_stems.most_common(50)]

cloud = WordCloud(width=3236,height=2000,background_color="white").generate(" ".join(top50))
